<template>
    <div class="news-edit-container">
        <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
            ...
            <el-form-item prop="info_cover2" id="inforCover2">
            ...
            <el-form-item label="内容编辑" prop="info_content">
                ...
                <text-editor ref="informationEditor" editorId="information-editor" :token="uptoken" :qnImgUrl="domain"></text-editor>
            </el-form-item>
            <el-form-item>
        ...
        <el-dialog title="预览" v-model="dialogVisible" size="small" @close="previewCancel" lock-scroll>
        ...
        data() {
            return {
                ...
                editFormRules: {
                    ...
                    info_cover: [
                        { required: true, message: '请上传主页资讯封面' }
                    ],
                    info_cover2: [
        ...
        methods: {
            ...
            editSubmit: function () {
                ...
                this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        ApiService.post({
                            'ext': 'information/manage/add',
                            'info_title': this.editForm.info_title,
                            'info_type': this.editForm.info_type,
            ...
            typeChange: function (value) {
                if (value == 1) {
                    document.getElementById('inforCover2').style.display = 'none';
                    this.editFormRules.info_cover2 = [];
                } else {
                    document.getElementById('inforCover2').style.display = 'block';
                    this.editFormRules.info_cover2 = [{ required: true, message: '请上传资讯封面' }];
                }
                this.editForm.info_type2 = '',
                this.getSecondType(value);
            },
