    ...
    <section>
        ...
        <el-col :span="24" class="toolbar">
            <el-form :inline="true">
                ...
                <el-form-item>
                    <el-button type="primary" v-on:click="getfashionShowOrderList">查询</el-button>
                </el-form-item>
            </el-form>
        </el-col>
        ...
        <!--//表格列表-->
        <template>
            <el-table :data="showOrderList" stripe style="width: 100%;" v-loading="listLoading">
                ...
                <el-table-column label="排序管理">
                    <template scope="scope">
                        <el-input :value="scope.row.custSort" @focus="changeSort(scope.row)"></el-input>
                    </template>
                </el-table-column>
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            this.getfashionShowOrderList();
        },
        methods: {
            getfashionShowOrderList() {
                ApiService.post({
                    'ext': 'discover/customer/page',
                    ...
                    .then(res => {
                        ...
                        this.showOrderList = res.data.data.list;
            ...
            changeSort: function (row) {
                this.$prompt('请输入序列号', '提示', {
                    ...
                    if (value) {
                        ApiService.put({
                            'ext': 'discover/customer/cust_sort',
                            'ids': row.custId,
                            'cust_sort': value
                        }).then(res => {
                            this.$notify({
